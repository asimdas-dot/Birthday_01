document.addEventListener("DOMContentLoaded", () => {
    ...
    // Show the blow controls after the cake and candle finish entering.
    window.setTimeout(() => {
        if (actionControls) {
    ...
    function extinguishCandle() {
        ...
        if (smoke) {
            window.setTimeout(() => smoke.classList.remove("hidden"), 450);
        }
    ...
    // Start listening only after the cake and candle are ready.
    window.setTimeout(initMicrophone, 7400);
});